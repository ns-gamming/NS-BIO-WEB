...
const PlatformDownloadCard = ({ platform, name, icon, color, delay, hasPage }: { platform: string; name: string; icon: string; color: string; delay: number; hasPage?: boolean }) => {
  ...
  return (
    <Card className="dark:bg-gray-900/95 dark:border-gray-800 hover:shadow-2xl transition-all duration-500 relative overflow-hidden border-2 rounded-2xl animate-bounceIn group" style={{ animationDelay: `${delay}s` }}>
      ...
      <CardContent className="relative z-10 space-y-3 pt-0">
        ...
        <div className="flex gap-2">
          {hasPage && (
            <span className="px-2 py-1 bg-blue-500/20 border border-blue-500/40 rounded text-xs font-semibold text-blue-600 dark:text-blue-400">
              Full Page Available
            </span>
          )}
          <Button
